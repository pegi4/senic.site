...
document
  ...
  .addEventListener("click", scrollToFirstSection);
...
document
  ...
  .forEach((dot) => dot.addEventListener("click", scrollToSection));
...
function calculateAge() {
  const birthdate = new Date("2004-09-26");
  ...
  document.getElementById("ac-age").textContent = age;
}
